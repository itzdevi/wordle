...
export default {
  ...
  methods: {
    addGuess() {
      ...
      if (guess.length != 5) {
        guessElem.placeholder = "GUESS MUST CONTAIN 5 LETTERS!";
        return;
      }
      if (!words.includes(guess)) {
        guessElem.placeholder = "ILLEGAL WORD!";
        return;
      }
...
<template>
  <div id="container">
    ...
    <input @keydown.enter="addGuess" ref="guessInput" id="guess-input" type="text">
  </div>
</template>
